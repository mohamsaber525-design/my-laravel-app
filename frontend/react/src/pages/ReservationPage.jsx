...
const ReservationPage = () => {
  ...
  const voyage = {
    ...
    destination: "Marrakech, Fès, Rabat, Meknès",
    duree: 8,
    prix: 4500,
    image: "https://images.unsplash.com/photo-1548086449-9bbf39c41cd4?w=400"
  };
  ...
  const handlePeopleChange = (increment) => {
    setFormData(prev => {
      ...
      return {
        ...
        total_amount: newCount * voyage.prix
      };
    });
  };
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <a href="/" className="flex items-center space-x-2">
            <div className="bg-orange-600 text-white p-2 rounded-lg font-bold text-xl">TM</div>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-md p-6">
                  ...
                  <div className="flex space-x-4">
                    <img src={voyage.image} alt={voyage.titre} className="w-24 h-24 rounded-lg object-cover" />
                    <div>
                      <h3 className="font-bold text-lg">{voyage.titre}</h3>
                      <p className="text-gray-600 flex items-center mt-1">
                        <MapPin className="w-4 h-4 mr-1" />{voyage.destination}
                      </p>
                      <p className="text-gray-600 flex items-center mt-1">
                        <Clock className="w-4 h-4 mr-1" />{voyage.duree} jours
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${
                          errors.date_reservation ? 'border-red-300' : 'border-gray-300'
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-md p-6">
                  ...
                  <label className={`flex items-start p-4 border-2 rounded-lg cursor-pointer ${
                    paymentMethod === 'bureau' ? 'border-orange-500 bg-orange-50' : 'border-gray-200'
                  }`}>
                    <input
                      type="radio"
                      value="bureau"
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    onClick={handleNextStep}
                    disabled={isLoading}
                    className="flex-1 bg-orange-600 text-white py-4 rounded-lg font-semibold hover:bg-orange-700 disabled:opacity-50"
                  >
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
              ...
              <div className="space-y-3 mb-6 pb-6 border-b">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{voyage.prix} MAD</span>
                </div>
                <div className="flex justify-between">
